...
<c:url var="urlList" value="/danh-sach-huong-dan-doc.html"/>
<html lang="en">
<head>
        ...
        <c:forEach var="item" items="${items.listResult}">
          <div class="image group">
            ...
            <div class="grid news_desc">
              <h3>${item.title}</h3>
              <c:url value="/noi-dung-bai-huong-dan-doc.html" var="detailUrl">
                <c:param name="readguidelineid" value="${item.readGuidelineId}"/>
              </c:url>
